import { ArenaSettingsManager } from "./arena-settings";

// ============================================
// SISTEMA DE BATALHA 2D -

export class QuantumBattle2DSystem {
  constructor(gallery) {
  ...
  setupEventListeners() {
    ...
    this.handleEscapeSkinSelector = (e) => {
      if (e.key === "Escape" && this.isSkinSelectorOpen()) {
        this.closeSkinSelector();
      }
    };
    window.addEventListener("keydown", this.handleEscapeSkinSelector);
    this.globalListeners.push(["keydown", this.handleEscapeSkinSelector]);

    // Prevenir rolagem com teclas de controle
    this.handlePreventControlScroll = (e) => {
    ...
    window.addEventListener("keydown", this.handlePreventControlScroll);
    this.globalListeners.push(["keydown", this.handlePreventControlScroll]);

    this.handleWindowBlur = () => {
      this.keys = {};
    };
    window.addEventListener("blur", this.handleWindowBlur);
    this.globalListeners.push(["blur", this.handleWindowBlur]);
  }
  ...
  setupKeyboard() {
    ...
    this.globalListeners.push(["keydown", this.handleKeydown]);
    ...
    this.globalListeners.push(["keyup", this.handleKeyup]);
  }
  ...
  destroy() {
    this.stopGame?.();
    this.closeSkinSelector?.();
    this.globalListeners.forEach(([eventName, handler]) => {
